...
{ pkgs, ... }:
{
  ...
  # --- Built-from-source skills (store paths) ---
  # oh-my-opencode-slim skills, packaged from upstream (pkgs/oh-my-opencode-slim,
  # pinned to tag v2.2.17 via fetchFromGitHub — updates are a version+hash bump,
  # never a manual copy). Byte-identical to the previously vendored copies.
